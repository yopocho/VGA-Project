...
#define VGA_TIM2_DMA_DELAY \
  37  // ease the delay when DMA START (Optimization = none)
// #define  VGA_TIM2_DMA_DELAY         30  // ease the delay when DMA START
// (Optimization = -O1)
...
#define VGA_GPIOE_ODR_ADDRESS \
  (VGA_GPIOE_BASE_ADR | VGA_GPIO_ODR_OFFSET | VGA_GPIO_BYTE_OFFSET)
