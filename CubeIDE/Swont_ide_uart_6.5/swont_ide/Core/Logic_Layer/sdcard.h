...
extern Error DrawRectangle(uint8_t xp, uint8_t yp, uint8_t Width, uint8_t Heigth,
		uint8_t color, uint8_t filled); Error DrawLine(uint8_t xp1, uint8_t yp1,
		uint8_t xp2, uint8_t yp2, uint8_t color, uint8_t thickness);
...
extern Error DrawCircle(uint16_t xp, uint16_t yp, uint16_t radius, uint8_t color);
